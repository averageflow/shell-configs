...
set path = (/sbin /bin /usr/sbin /usr/bin /usr/local/sbin /usr/local/bin $HOME/bin /Users/joe/Development/SDKs/go1.15.2/bin /Applications/MAMP/bin/php/php7.4.2/bin /Users/joe/Development/SDKs/go/bin)
